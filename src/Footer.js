                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-7 col-12">
                            <p className="copyright-text mb-0">Copyright © Vishwas 2050 <a href="#">Heart</a> Charity & Save Life Org.
                        	Design: <a href="https://templatemo.com" target="_blank">Vishwas</a></p>
                        </div>
